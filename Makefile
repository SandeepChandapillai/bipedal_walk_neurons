...
dist: 
	@test -d .tmp/LIPM_21.0.0 || mkdir -p .tmp/LIPM_21.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LIPM_21.0.0/ && $(COPY_FILE) --parents mainwindow.h lipm_model.h network.h neuron.h cnb.h .tmp/LIPM_21.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp lipm_model.cpp network.cpp neuron.cpp cnb.cpp .tmp/LIPM_21.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/LIPM_21.0.0/ && (cd `dirname .tmp/LIPM_21.0.0` && $(TAR) LIPM_21.0.0.tar LIPM_21.0.0 && $(COMPRESS) LIPM_21.0.0.tar) && $(MOVE) `dirname .tmp/LIPM_21.0.0`/LIPM_21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LIPM_21.0.0
